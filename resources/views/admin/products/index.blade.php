...
@section('content')
<div class="row">
<a href="{{ route('admin.products.export') }}" class="btn btn-success">Export</a>
    ...
    <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-xs btn-primary" href="{{ route('admin.products.show', $product->id) }}" data-toggle="tooltip" data-placement="top" title="{{ __('views.admin.products.index.show') }}">
                        <i class="fa fa-eye"></i>
                    </a>
                    <a class="btn btn-xs btn-info" href="{{ route('admin.products.edit', $product->id) }}" data-toggle="tooltip" data-placement="top" title="{{ __('views.admin.products.index.edit') }}">
                        <i class="fa fa-pencil"></i>
                    </a>
                    <a href="{{ route('admin.products.destroy', $product->id) }}" class="btn btn-xs btn-danger user_destroy" data-toggle="tooltip" data-placement="top" title="{{ __('views.admin.products.index.delete') }}">
